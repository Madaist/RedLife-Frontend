...
export class AchievementsServiceProxy {
     ...
     * @return Success
     */
    getTopByLeagueId(leagueId: number | undefined): Observable<UserDto[]> {
        let url_ = this.baseUrl + "/api/services/app/Achievements/GetTopByLeagueId?";
        if (leagueId === null)
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processGetTopByLeagueId(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processGetTopByLeagueId(<any>response_);
                } catch (e) {
    ...
    protected processGetTopByLeagueId(response: HttpResponseBase): Observable<UserDto[]> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
...
export class AppointmentServiceProxy {
     ...
     * @return Success
     */
    getAll(keyword: string | null | undefined, skipCount: number | undefined, maxResultCount: number | undefined): Observable<AppointmentDtoPagedResultDto> {
    ...
    /**
     * @param donorId (optional) 
     * @param date (optional) 
     * @return Success
     */
    isAppointmentDateValid(donorId: number | undefined, date: moment.Moment | undefined): Observable<boolean> {
        let url_ = this.baseUrl + "/api/services/app/Appointment/IsAppointmentDateValid?";
        if (donorId === null)
            throw new Error("The parameter 'donorId' cannot be null.");
        ...
        return this.http.request("post", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processIsAppointmentDateValid(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processIsAppointmentDateValid(<any>response_);
                } catch (e) {
    ...
    protected processIsAppointmentDateValid(response: HttpResponseBase): Observable<boolean> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
...
@Injectable()
export class DonationServiceProxy {
    private http: HttpClient;
    private baseUrl: string;
    protected jsonParseReviver: ((key: string, value: any) => any) | undefined = undefined;
     ...
     * @return Success
     */
    get(id: string | null | undefined): Observable<DonationDto> {
        let url_ = this.baseUrl + "/api/services/app/Donation/Get?";
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    ...
                    return <Observable<DonationDto>><any>_observableThrow(e);
                }
            } else
                return <Observable<DonationDto>><any>_observableThrow(response_);
        }));
    }

    protected processGet(response: HttpResponseBase): Observable<DonationDto> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
        ...
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = DonationDto.fromJS(resultData200);
            return _observableOf(result200);
            }));
        } else if (status !== 200 && status !== 204) {
            return blobToText(responseBlob).pipe(_observableMergeMap(_responseText => {
        ...
        return _observableOf<DonationDto>(<any>null);
    }
     ...
     * @return Success
     */
    getAll(keyword: string | null | undefined, skipCount: number | undefined, maxResultCount: number | undefined): Observable<DonationDtoPagedResultDto> {
        let url_ = this.baseUrl + "/api/services/app/Donation/GetAll?";
        if (keyword !== undefined && keyword !== null)
            url_ += "Keyword=" + encodeURIComponent("" + keyword) + "&";
        if (skipCount === null)
            throw new Error("The parameter 'skipCount' cannot be null.");
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    ...
                    return <Observable<DonationDtoPagedResultDto>><any>_observableThrow(e);
                }
            } else
                return <Observable<DonationDtoPagedResultDto>><any>_observableThrow(response_);
        }));
    }

    protected processGetAll(response: HttpResponseBase): Observable<DonationDtoPagedResultDto> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
        ...
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = DonationDtoPagedResultDto.fromJS(resultData200);
            return _observableOf(result200);
            }));
        } else if (status !== 200 && status !== 204) {
            return blobToText(responseBlob).pipe(_observableMergeMap(_responseText => {
        ...
        return _observableOf<DonationDtoPagedResultDto>(<any>null);
    }
     ...
     * @return Success
     */
    update(body: UpdateDonationDto | undefined): Observable<DonationDto> {
        let url_ = this.baseUrl + "/api/services/app/Donation/Update";
        url_ = url_.replace(/[?&]$/, "");
    ...
    protected processUpdate(response: HttpResponseBase): Observable<DonationDto> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
     ...
     * @return Success
     */
    create(body: CreateDonationDto | undefined): Observable<DonationDto> {
        let url_ = this.baseUrl + "/api/services/app/Donation/Create";
        url_ = url_.replace(/[?&]$/, "");
    ...
    protected processCreate(response: HttpResponseBase): Observable<DonationDto> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
    ...
    delete(id: string | null | undefined): Observable<void> {
        let url_ = this.baseUrl + "/api/services/app/Donation/Delete?";
        if (id !== undefined && id !== null)
            url_ += "Id=" + encodeURIComponent("" + id) + "&";
        url_ = url_.replace(/[?&]$/, "");
...
@Injectable()
export class LeagueServiceProxy {
    private http: HttpClient;
    private baseUrl: string;
    protected jsonParseReviver: ((key: string, value: any) => any) | undefined = undefined;
     ...
     * @return Success
     */
    getAll(): Observable<LeagueDto[]> {
        let url_ = this.baseUrl + "/api/services/app/League/GetAll";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    ...
                    return <Observable<LeagueDto[]>><any>_observableThrow(e);
                }
            } else
                return <Observable<LeagueDto[]>><any>_observableThrow(response_);
        }));
    }

    protected processGetAll(response: HttpResponseBase): Observable<LeagueDto[]> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
        ...
        return _observableOf<LeagueDto[]>(<any>null);
    }
}
...
@Injectable()
export class TransfusionServiceProxy {
    private http: HttpClient;
    private baseUrl: string;
    protected jsonParseReviver: ((key: string, value: any) => any) | undefined = undefined;
     ...
     * @return Success
     */
    get(id: string | null | undefined): Observable<TransfusionDto> {
        let url_ = this.baseUrl + "/api/services/app/Transfusion/Get?";
        if (id !== undefined && id !== null)
            url_ += "Id=" + encodeURIComponent("" + id) + "&";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    ...
                    return <Observable<TransfusionDto>><any>_observableThrow(e);
                }
            } else
                return <Observable<TransfusionDto>><any>_observableThrow(response_);
        }));
    }

    protected processGet(response: HttpResponseBase): Observable<TransfusionDto> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
        ...
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = TransfusionDto.fromJS(resultData200);
            return _observableOf(result200);
            }));
        } else if (status !== 200 && status !== 204) {
            return blobToText(responseBlob).pipe(_observableMergeMap(_responseText => {
        ...
        return _observableOf<TransfusionDto>(<any>null);
    }
     ...
     * @return Success
     */
    getAll(keyword: string | null | undefined, skipCount: number | undefined, maxResultCount: number | undefined): Observable<TransfusionDtoPagedResultDto> {
        let url_ = this.baseUrl + "/api/services/app/Transfusion/GetAll?";
        if (keyword !== undefined && keyword !== null)
            url_ += "Keyword=" + encodeURIComponent("" + keyword) + "&";
        if (skipCount === null)
            throw new Error("The parameter 'skipCount' cannot be null.");
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    ...
                    return <Observable<TransfusionDtoPagedResultDto>><any>_observableThrow(e);
                }
            } else
                return <Observable<TransfusionDtoPagedResultDto>><any>_observableThrow(response_);
        }));
    }

    protected processGetAll(response: HttpResponseBase): Observable<TransfusionDtoPagedResultDto> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
        ...
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = TransfusionDtoPagedResultDto.fromJS(resultData200);
            return _observableOf(result200);
            }));
        } else if (status !== 200 && status !== 204) {
            return blobToText(responseBlob).pipe(_observableMergeMap(_responseText => {
        ...
        return _observableOf<TransfusionDtoPagedResultDto>(<any>null);
    }
     ...
     * @return Success
     */
    update(body: UpdateTransfusionDto | undefined): Observable<TransfusionDto> {
        let url_ = this.baseUrl + "/api/services/app/Transfusion/Update";
        url_ = url_.replace(/[?&]$/, "");
    ...
    protected processUpdate(response: HttpResponseBase): Observable<TransfusionDto> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
     ...
     * @return Success
     */
    create(body: CreateTransfusionDto | undefined): Observable<TransfusionDto> {
        let url_ = this.baseUrl + "/api/services/app/Transfusion/Create";
        url_ = url_.replace(/[?&]$/, "");
    ...
    protected processCreate(response: HttpResponseBase): Observable<TransfusionDto> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
     ...
     */
    delete(id: string | null | undefined): Observable<void> {
        let url_ = this.baseUrl + "/api/services/app/Transfusion/Delete?";
        if (id !== undefined && id !== null)
            url_ += "Id=" + encodeURIComponent("" + id) + "&";
        url_ = url_.replace(/[?&]$/, "");
...
export class UserServiceProxy {
     ...
     * @return Success
     */
    getTransfusionCenters(): Observable<UserDtoListResultDto> {
        let url_ = this.baseUrl + "/api/services/app/User/GetTransfusionCenters";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processGetTransfusionCenters(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processGetTransfusionCenters(<any>response_);
                } catch (e) {
    ...
    protected processGetTransfusionCenters(response: HttpResponseBase): Observable<UserDtoListResultDto> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
     ...
     * @return Success
     */
    getDonors(): Observable<UserDtoListResultDto> {
        let url_ = this.baseUrl + "/api/services/app/User/GetDonors";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processGetDonors(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processGetDonors(<any>response_);
                } catch (e) {
                    return <Observable<UserDtoListResultDto>><any>_observableThrow(e);
                }
            } else
    ...
    protected processGetDonors(response: HttpResponseBase): Observable<UserDtoListResultDto> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
...
export class DonationDtoPagedResultDto implements IDonationDtoPagedResultDto {
    totalCount: number;
    items: DonationDto[] | undefined;

    constructor(data?: IDonationDtoPagedResultDto) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    init(_data?: any) {
        if (_data) {
            ...
            if (Array.isArray(_data["items"])) {
                this.items = [] as any;
                for (let item of _data["items"])
                    this.items.push(DonationDto.fromJS(item));
            }
        }
    }

    static fromJS(data: any): DonationDtoPagedResultDto {
        data = typeof data === 'object' ? data : {};
        let result = new DonationDtoPagedResultDto();
        result.init(data);
        return result;
    }
    ...
    clone(): DonationDtoPagedResultDto {
        const json = this.toJSON();
        let result = new DonationDtoPagedResultDto();
        result.init(json);
        return result;
...
export interface IDonationDtoPagedResultDto {
    totalCount: number;
    items: DonationDto[] | undefined;
}

export class UpdateDonationDto implements IUpdateDonationDto {
    donorId: number;
    centerId: number;
    date: string | undefined;
    isBloodAccepted: boolean;
    ...
    static fromJS(data: any): UpdateDonationDto {
        data = typeof data === 'object' ? data : {};
        let result = new UpdateDonationDto();
        result.init(data);
        return result;
    }
...
export interface IUpdateDonationDto {
    donorId: number;
    centerId: number;
    date: string | undefined;
    isBloodAccepted: boolean;
...
export class CreateDonationDto implements ICreateDonationDto {
    ...
    static fromJS(data: any): CreateDonationDto {
        data = typeof data === 'object' ? data : {};
        let result = new CreateDonationDto();
        result.init(data);
        return result;
    }
...
export class TransfusionDto implements ITransfusionDto {
    ...
    static fromJS(data: any): TransfusionDto {
        data = typeof data === 'object' ? data : {};
        let result = new TransfusionDto();
        result.init(data);
        return result;
    }
...
export class TransfusionDtoPagedResultDto implements ITransfusionDtoPagedResultDto {
    totalCount: number;
    items: TransfusionDto[] | undefined;

    constructor(data?: ITransfusionDtoPagedResultDto) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    init(_data?: any) {
        if (_data) {
            ...
            if (Array.isArray(_data["items"])) {
                this.items = [] as any;
                for (let item of _data["items"])
                    this.items.push(TransfusionDto.fromJS(item));
            }
        }
    }

    static fromJS(data: any): TransfusionDtoPagedResultDto {
        data = typeof data === 'object' ? data : {};
        let result = new TransfusionDtoPagedResultDto();
        result.init(data);
        return result;
    }
    ...
    clone(): TransfusionDtoPagedResultDto {
        const json = this.toJSON();
        let result = new TransfusionDtoPagedResultDto();
        result.init(json);
        return result;
...
export interface ITransfusionDtoPagedResultDto {
    totalCount: number;
    items: TransfusionDto[] | undefined;
}
...
export class UpdateTransfusionDto implements IUpdateTransfusionDto {
    ...
    static fromJS(data: any): UpdateTransfusionDto {
        data = typeof data === 'object' ? data : {};
        let result = new UpdateTransfusionDto();
        result.init(data);
        return result;
    }
...
export class CreateTransfusionDto implements ICreateTransfusionDto {
    ...
    static fromJS(data: any): CreateTransfusionDto {
        data = typeof data === 'object' ? data : {};
        let result = new CreateTransfusionDto();
        result.init(data);
        return result;
    }
